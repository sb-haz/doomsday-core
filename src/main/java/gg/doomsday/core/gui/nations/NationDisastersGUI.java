...
public class NationDisastersGUI extends NavigationGUI {
    
    private final NationManager nationManager;
    private final NationPlayerManager playerManager;
    private final String nationId;
    
    public NationDisastersGUI(GUIManager guiManager, NationManager nationManager, NationPlayerManager playerManager, String nationId) {
        super(getNationDisplayName(nationManager, nationId) + " Disasters", 54, guiManager);
    ...
    public Inventory build(Player player) {
        ...
        GUIBuilder.addTitleItem(gui, 4, org.bukkit.Material.BLAZE_POWDER, 
            "&4&l" + getNationDisplayName(nationManager, nationId) + " Natural Disasters",
